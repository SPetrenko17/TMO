...
st.write(data['bmi'].value_counts())

# model кодируем в 1/0
data['Ischildren'] = data.children.replace({'no': 0, 'yes': 1})
...
ax.scatter(x=data['age'], y=data['charges'])
plt.xlabel("age")
plt.ylabel("charges")
st.pyplot(fig)
...
f, ax = plt.subplots()
sns.violinplot(x=data['charges'])
st.pyplot(f)

st.subheader('Масштабирование данных')
f, ax = plt.subplots()
plt.hist(data['charges'], 50)
plt.show()
st.pyplot(f)

f, ax = plt.subplots()
plt.hist(data['Ischildren'], 50)
plt.show()
st.pyplot(f)
...
fig1 = plt.figure(figsize=(7, 5))
ax = plt.scatter(X_test['age_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['age_scaled'], Y_predict3, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('age_scaled')
plt.ylabel('charges')
plt.plot(n_estimators_1)
...
ax = plt.scatter(X_test['age_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['age_scaled'], Y_grad_pred, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('age_scaled')
plt.ylabel('charges')
...
grad1 = GradientBoostingRegressor(n_estimators=25, max_features=0.8, min_samples_leaf=0.08, random_state=10)
...
fig1 = plt.figure(figsize=(7, 5))
ax = plt.scatter(X_test['age_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['age_scaled'], Y_grad_pred1, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('age_scaled')
plt.ylabel('charges')
plt.plot(n_estimators_1)
...
plt.scatter(X_test['age_scaled'], Y_test, marker='s', label='Тестовая выборка')
plt.scatter(X_test['age_scaled'], lr_y_pred, marker='o', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('age_scaled')
plt.ylabel('charges')
plt.show()
